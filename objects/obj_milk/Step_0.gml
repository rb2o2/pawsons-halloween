...
//animating
	...
	ds_list_add(variable_instance_get(self,"_slides"), 1);
	if (!obj_wall_generator.nowall_dr(room,variable_instance_get(self,"i"),variable_instance_get(self,"j")) || !is_undefined(solid_block(dr(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[0],dr(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[1]))) {
		ds_list_delete(variable_instance_get(self,"_slides"),ds_list_find_index(variable_instance_get(self,"_slides"), 1));
	}
	if (!obj_wall_generator.nowall_dl(room,variable_instance_get(self,"i"),variable_instance_get(self,"j")) || !is_undefined(solid_block(dl(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[0],dl(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[1]))) {
		ds_list_delete(variable_instance_get(self,"_slides"),ds_list_find_index(variable_instance_get(self,"_slides"), -1));
	}
	if(obj_wall_generator.nowall_dn(room,variable_instance_get(self,"i"),variable_instance_get(self,"j")) && is_undefined(solid_block(dn(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[0],dn(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[1]))) {
	...
	if (!variable_instance_get(self,"slide_anim") && ds_list_size(variable_instance_get(self,"_slides"))>0) {
		if (ds_list_find_index(variable_instance_get(self,"_slides"), 0) == -1 && 
			ds_list_find_index(variable_instance_get(self,"_slides"),-1) != -1 &&
			ds_list_find_index(variable_instance_get(self,"_slides"),1) != -1) {
				if (right) {
		...
		else if (ds_list_find_index(variable_instance_get(self,"_slides"), 0) != -1) {
		...
		} else if (ds_list_find_index(variable_instance_get(self,"_slides"), -1) != -1) {
			variable_instance_set(self,"yfin", yshift(room,dl(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[0],dl(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[1]));
			variable_instance_set(self,"xfin", xshift(room,dl(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[0],dl(variable_instance_get(self,"i"),variable_instance_get(self,"j"))[1]));
			variable_instance_set( self, "slide_dir",  -1);
			variable_instance_set(self,"slide_anim", true);
